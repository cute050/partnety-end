...
public class CodeGenerator {
    ...
    private static final String PACKAGE_NAME = "com.jobv";
    private static final String AUTHOR = "程序员jobv";

    /*=========================  下面的不用改动  =========================*/

    private static final String PROJECT_PATH = System.getProperty("G:/project/partnety");
